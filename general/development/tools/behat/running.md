...
This environment variable should work for all Moodle CLI scripts, except those within the admin/tool/behat and admin/tool/phpunit directories, which ignore it because it would not make sense there.
